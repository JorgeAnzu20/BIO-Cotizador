                  ...
                  <AnimatePresence initial={false}>
                    {sellerMetrics.map((seller, index) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              borderRadius: 999,
                              background:
                                seller.totalConfirmadas > 0
                                  ? COLORS.greenSoft
                                  : COLORS.yellowSoft,
                              color:
                                seller.totalConfirmadas > 0 ? "#166534" : "#92400E",
                              fontWeight: 700,
                              fontSize: 12,
                            }}
                          >
                        ...
                        >
                          <SmallMetricCard
                            title="Proformas hechas"
                            value={String(seller.totalProformas)}
                          />
                          <SmallMetricCard
                            title="Ventas confirmadas"
                            value={String(seller.totalConfirmadas)}
                          />
                          <SmallMetricCard
                            title="Ventas hoy"
                            value={String(seller.ventasHoy)}
                          />
                          <SmallMetricCard
                            title="Ventas mes"
                            value={String(seller.ventasMes)}
                          />
                        </div>
                      </motion.div>
                    ))}
